		...
		function service($http) {
			...
			return {
...

				{
					...
					path: '/assets/images/Gallery/PicturesGallery/img'
...

				{
					...
					path: '/assets/images/Gallery/Recommended/EiffelTowerGallery/tower'
				},

				{
					...
					path: '/assets/images/Gallery/Recommended/LouvreGallery/louvre'
				},

				{
					...
					path: '/assets/images/Gallery/Recommended/TriompheGallery/arc'
				},

				{
					...
					path: '/assets/images/Gallery/Outside/TuileriesGallery/garden'
...

				{
					...
					path: '/assets/images/Gallery/Inside/Opera/opera'
				},

				{
					...
					path: '/assets/images/Gallery/Inside/Basilica/basilica'
				},

				{
					...
					path: '/assets/images/Gallery/Outside/DisneyLand/disney'
				},

				{
					...
					path: '/assets/images/Gallery/Outside/Sena/sena'
				},

				{
					...
					path: '/assets/images/Gallery/Outside/BridgeGallery/bridge'
				},
...

				{
					...
					path: '/assets/images/Gallery/Outside/ConcordeGallery/concorde'
				},

				{
					...
					path: '/assets/images/Gallery/Outside/LuxembourgGallery/garden'
				},

				{
					...
					path: '/assets/images/Gallery/Inside/PantheonGallery/pantheon'
				},

				{
					...
					path: '/assets/images/Gallery/Outside/VersaillesGallery/versailles'
				},

				{
					...
					path: '/assets/images/Gallery/Recommended/NotreDameGallery/notreDame'
				},

				{
					...
					path: '/assets/images/Gallery/Recommended/ChampsElyseesGallery/champs'
				},

				{
					...
					path: '/assets/images/Gallery/Inside/LaDefenseGallery/defense'
				},

				{
					...
					path: '/assets/images/Gallery/Recommended/RougeGallery/rouge'
				},
